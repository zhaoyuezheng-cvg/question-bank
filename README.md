...
### v1.5.0 - 体验打磨（2026-06-25）

**🎨 Toast 撤销按钮持久化**
- 带操作按钮的 Toast 不再自动消失，需手动关闭
- 删除后撤销按钮始终可见，不会错过
...
**🎯 题目难度自动推荐**
- 新增 API：基于同类题目的答题正确率推荐难度
- 正确率最接近 60% 的难度为推荐值

**🌙 深色模式无闪烁**
- HTML 渲染前就读取 localStorage 设置主题
- 消除白屏闪烁

**✨ 页面过渡动画增强**
- 路由切换使用 fade + translateY 过渡
- 进入时上滑淡入，退出时上滑淡出

**📊 数据统计导出报告**
- 数据分析页新增「导出报告」按钮
- 导出为 Markdown 格式，包含概览/学科/薄弱知识点
